---
title: "Optimizing RF ntree_OOB_NEE and CH4" #using OOB (out of bag error) to determine optimum number of trees for training RF model - optimal number of trees is lowest ntree with minimal improvement in OOB 
...
#OOB ntree for SWC in RF --> used ntree = 800 in step 2
