...
knitr::opts_knit$set(root.dir = 'C:/Users/karndt.WHRC/Desktop/sites/council/data') #edit & use this to set your directory
```
...
df = fread(input = "C:/Users/kkent/Documents/Council Data/Council BASE gapfilling/council_gapfilled_clean_2017_2023.csv")
```
...
US_NGC2 = data.frame(TIMESTAMP_START,TIMESTAMP_END,
  CO2,CH4,H2O
...
```{r}
siteID = "US-NGC2" #adding the 2 to differentiate from US-NGC, as the site will get a new ID, TBD
resolution = 'HH'
tsstart = US_NGC2$TIMESTAMP_START[1]
tsend   = US_NGC2$TIMESTAMP_END[nrow(US_NGC2)]

filename = paste(siteID,resolution,tsstart,tsend,sep = '_') #adds the beginning and end time of df to the file name 
filename = paste("./",filename,".csv",sep = "")

write.csv(x = US_NGC2,file = filename,row.names = F,na = "-9999",quote = F)

#final doc name will look like this: US-NGC2_HH_201701010000_202309010000.csv 
