...
SWC_4_1_1 = df$SWC_4_1_1.c #KK 1/6/2024 -> forgot to add this into latest, need to add in and redo steps**
SWC_5_1_1 = df$SWC_5_1_1.c #KK 1/6/2024 -> forgot to add this into latest, need to add in and redo steps**
...
```{r}
siteID = "US-NGC2.2" #adding the 2 to differentiate from US-NGC, as the site will get a new ID, TBD 
resolution = 'HH'
...
#final doc name will look like this: US-NGC2_HH_201701010000_202309010000.csv --> saves to my council data folder 
