...
dat.h =fread("C:/Users/kkent/Documents/Github Flux Network/Council BASE prepping/Council_BASE-data-prepping/data/council_2017_2023_gf.csv", header = T, nrows = 0) #header

dat =fread("C:/Users/kkent/Documents/Github Flux Network/Council BASE prepping/Council_BASE-data-prepping/data/council_2017_2023_gf.csv", header = F, skip = 2) #removes the row with the units
...
dat =fread("C:/Users/kkent/Documents/Council Data/Council BASE gapfilling/council_2017_2023_gf.csv") 
```
...
#".2" represents the adj SWC (tussock) re-run (though I think I already re-ran it with the SWC, so likely orig file is already this same file)
