...
#should I be gapfilling wind direction? 
#WD before mini gapfill 
sum(is.na(df$WD)) #66561

#wind direction (degrees, 0-360)
df$WD = na.spline(df$WD,maxgap = gap)

sum(is.na(df$WD)) #now 66235
```
...
sum(is.na(df$WD)) #66235
sum(is.na(df$Cardinal_Direction)) #66235
