...
plot(ntree_values, oob_errors, type = "b", xlab = "Number of Trees", ylab = "OOB Error")



print(ntree_values) # correct 100 - 1000 by 100
print(oob_errors)
length(ntree_values) == length(oob_errors)
...
cf$rf_model_ntree = pnee.1000

# Extract variable importance
importance_values_ntree <- importance(rf_model_ntree, type = 1)  # type = 1 for %IncMSE

# Print the importance values
print(importance_values_ntree)
#Results:
#         %IncMSE
# tair   43.41093
# rh     92.00179 --> fourth
# rg     47.39703
# ws     98.81765  --> third 
# wd    128.92794 --> second most important
# tsoil  82.74165
# swc   138.27417 ----> most important 
# vpd    49.63176
# le     62.56852
# h      83.76193
...
varImpPlot(rf_model_ntree, type = 1, main = "Variable Importance (%IncMSE)")
...
#plot of certain timeframes using wd (degrees) -- used this version of the model 
ggplot(data = cf)+theme_bw()+
