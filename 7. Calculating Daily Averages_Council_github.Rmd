...
#Reminder note, re-ran all these on 1/3/25 based on the updated RF model using the SWC from tussock (originally from pond, SWC_1) --> added a ".2" to differentiate the previous flux dataset to the new one based on the adj SWC 
